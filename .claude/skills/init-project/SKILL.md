---
name: init-project
description: This skill should be used when the user asks to "initialize the project", "set up the project locally", "run init-project", or needs help getting the development environment running for the first time.
---
