...
export const YAAG_TOPICS: YAAGTopic[] = [
	...
	},
	{
		...
		lessons: [
			{ number: "", title: "Find the Greatest Common Factor" },
			{ number: "", title: "Use the Distributive Property to Factor Expressions" },
			{ number: "", title: "Write Equivalent Numerical Expressions" },
			{ number: "", title: "Write Equivalent Expressions" },
		],
		isG6Prep: true,
	},
	{
		...
		lessons: [
			{ number: "", title: "Add Decimals" },
			{ number: "", title: "Add and Subtract Decimals" },
			{ number: "", title: "Multiply Decimals" },
			{ number: "", title: "Divide Decimals" },
		],
		isG6Prep: true,
	},
	{
		...
		lessons: [
			{ number: "", title: "Add and Subtract Fractions and Mixed Numbers" },
			{ number: "", title: "Multiply Fractions" },
			{ number: "", title: "Compute Quotients with Fractions" },
		],
		isG6Prep: true,
	},
];
