...
export const ambientScanLimiter = createRateLimiter(300, 60_000); // 300 req/min (waveform amplitude — 5/sec per teacher)
...
export const questionExtractLimiter = createRateLimiter(5, 60_000); // 5 req/min (Claude PDF question extraction)
